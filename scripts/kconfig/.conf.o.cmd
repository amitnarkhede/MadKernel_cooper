cmd_scripts/kconfig/conf.o := gcc -Wp,-MD,scripts/kconfig/.conf.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -fomit-frame-pointer   -DCURSES_LOC="<curses.h>" -DLOCALE   -c -o scripts/kconfig/conf.o scripts/kconfig/conf.c
