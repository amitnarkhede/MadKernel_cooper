...
@ -I /home/amit/Desktop/GT-S5830_Kernel/arch/arm/include -I include
@ -I arch/arm/mach-msm/include
@ -iprefix /home/amit/CodeSourcery/Sourcery_CodeBench_Lite_for_ARM_EABI/bin/../lib/gcc/arm-none-eabi/4.6.3/
@ -isysroot /home/amit/CodeSourcery/Sourcery_CodeBench_Lite_for_ARM_EABI/bin/../arm-none-eabi
...
@ -D __CS_SOURCERYGXX_REV__=56
@ -isystem /home/amit/CodeSourcery/Sourcery_CodeBench_Lite_for_ARM_EABI/bin/../lib/gcc/arm-none-eabi/4.6.3/include
@ -include include/generated/autoconf.h -MD kernel/.bounds.s.d
@ kernel/bounds.c -mlittle-endian -march=armv6 -mfpu=vfp -mtune=arm1136j-s
@ -marm -mapcs -mno-sched-prolog -mabi=aapcs-linux -mno-thumb-interwork
@ -march=armv6k -mtune=arm1136j-s -msoft-float
@ -auxbase-strip kernel/bounds.s -g -Os -Wall -Wundef -Wstrict-prototypes
@ -Wno-trigraphs -Wno-format-security -Wno-unused-but-set-variable
@ -Wno-unitialised -Wno-unused-result -Wframe-larger-than=2048
@ -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-aliasing
@ -fno-common -fno-delete-null-pointer-checks -ffast-math
...
@ -fpeephole -fpeephole2 -fprefetch-loop-arrays -freciprocal-math
...
@ -fshow-column -fsplit-ivs-in-unroller -fsplit-wide-types
...
.LASF37:
	.ascii	"PG_pinned\000"
.LASF49:
	.ascii	"/home/amit/Desktop/GT-S5830_Kernel\000"
.LASF29:
